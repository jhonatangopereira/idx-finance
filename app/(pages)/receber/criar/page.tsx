...
export default function CriarReceita() {
  ...
  const changePercentage = useCallback(
    (value: number) => {
      setPercentage(value);
    },
    [percentage]
  ...
  const getFields = async (fields: any) => {
    const formatedFields = formatFields(
      fields,
      hasInstallment,
      apportionments,
      installmentValues
                ...
                <section className={Styles.LaunchInformation}>
                  ...
                  <div className={Styles.LabelInputContainer}>
                    <label className={Styles.Label}>
                      Cliente <span className={Styles.AsterisckSpan}>*</span>
                    </label>
                    <input
                    ...
                    />
                    {errors.client && (
                      <p className={Styles.Error}>{errors.client.message}</p>
                    )}
                  </div>
                  <div className={Styles.LabelInputContainer}>
                    <label className={Styles.Label}>
